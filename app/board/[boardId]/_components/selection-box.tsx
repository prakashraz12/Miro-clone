...
import { HANDLE_WIDTH } from "@/config/toast-messages";
...
export const SelectionBox = memo(({
    ...
    return (
        <>
            <rect className="fill-transparent stroke-blue-500 stroke-1 pointer-events-none" style={{ transform: `translate(${bounds.x}px, ${bounds.y}px)`, }}
                x={0}
                y={0}
                width={bounds.width}
